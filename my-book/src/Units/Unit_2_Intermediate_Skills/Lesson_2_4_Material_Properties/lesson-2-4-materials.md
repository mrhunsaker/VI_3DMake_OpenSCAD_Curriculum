# Lesson 2.4: Material Properties — PLA, PETG, and TPU (Self-Paced)

**Accessibility:** Include short text descriptions of any images and annotate material comparison tests so screen-reader users can follow procedure and results.
